...
public class Order {
	@Test(dataProvider="party")
	public void order(String firstname, String lastname, String email, String password, String mobile, String add1, String add2, String city, String zip, String count) throws InterruptedException
	{
